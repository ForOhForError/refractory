...
urlpatterns = [
    ...
    path('instance/<slug:instance_slug>/activate/', activate_instance, name='activate_instance'),
    path('instance/<slug:instance_slug>/admin_login/', login_to_instance_as_admin, name='instance_admin_login'),
    path('instance/<slug:instance_slug>/gm_login/', login_to_instance_as_managed_gm, name='managed_admin_login'),
    path('instance/<slug:instance_slug>/activate/<slug:world_id>/', activate_world, name="activate_world"),
]
